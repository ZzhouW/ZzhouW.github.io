...
function getPoints(num, start , controll1 , controll2 , end) {
	...
	// 二阶贝塞尔
	return bezierPoints = bezier.getBezierPoints(dotNumber, p1, c1,c2, p2).map(d => {
		return d.map(e => parseInt(e, 10));
	});
	return bezierPoints;
}
